...
### down (point2)
### P_b, T, R, rho, a_fr, V, gamma
array_x_3[num_ch_up][0] = 60.480
array_y_3[num_ch_up][0] = 59.625
array_theta_3[num_ch_up][0] = 30.122 * 2. * np.pi / 360.
array_V_3[num_ch_up][0] = 2274.2
array_p_3[num_ch_up][0] = 1.9597 * 10. ** 5.
array_rho_3[num_ch_up][0] = 0.37046
### down (point3)
### P_b, T, R, rho, a_fr, V, gamma
array_x[num_ch_up-1][0] = 55.943
array_y[num_ch_up-1][0] = 58.845
array_theta[num_ch_up-1][0] = 30.752 * 2. * np.pi / 360.
array_V[num_ch_up-1][0] = 2252.9
array_p[num_ch_up-1][0] = 2.1453 * 10. ** 5.
array_rho[num_ch_up-1][0] = 0.39947
#============================================================================
#============================================================================
...
### nozzle contour
a_nozzle_1 = 0.71568
a_nozzle_2 = 0.0021574


print("===============================================================")
print("free boundary condition")
print("===============================================================")
print("p_3           ", array_p[num_ch_up-1][1])
print("V_3           ", array_V[num_ch_up-1][1])
print("rho_3         ", array_rho[num_ch_up-1][1])
# print("rho_3         ")
