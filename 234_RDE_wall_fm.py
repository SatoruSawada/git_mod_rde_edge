...
# print("array_theta_up1 ============", array_theta_up * 360. / 2./ np.pi)
...
# print("array_theta_down 1 ============", array_theta_down * 360. / 2./ np.pi)
