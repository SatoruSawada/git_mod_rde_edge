...
# print("array_sample_up1 ============", array_sample_up0 * 360. / 2./ np.pi)

# ### 流線角度：差が増加
# array_sample_up = np.linspace(0,num_ch_up,num_ch_up)
# array_sample_up = array_sample_up * array_sample_up
# array_sample_up_delta = angle_sl / array_sample_up[-1]
# array_sample_up = array_sample_up * array_sample_up_delta
# print("array_sample_up2 ============", array_sample_up * 360. / 2./ np.pi)

### 流線角度：任意
# array_sample_up = np.array([10., 10.001, 10.002, 12.5, 14., 17., 20., 24., 28., 30.])/360.*2.*np.pi
# array_sample_up = np.array([10., 14, 18, 20, 22., 24., 26., 27., 28.5, 30.])/360.*2.*np.pi
# array_sample_up = np.array([10., 10.01, 10.2, 11., 13., 15., 17., 20., 25., 30.])/360.*2.*np.pi
# array_sample_up = np.array([10., 10.1, 10.2, 13., 14., 15., 17., 20., 25., 30.])/360.*2.*np.pi
# print("array_sample_up2 ============", array_sample_up * 360. / 2./ np.pi)
...
array_neu_up = array_sample_up
array_neu_up = array_neu_up - angle_fm
# print('array_neu_up[0]',array_neu_up[:5])
...
# print('alpha')
# print(array_alpha_up/2./np.pi*360.)
...
### 流線角度：差が増加
# array_sample = np.linspace(0,num_ch_down,num_ch_down)
# array_sample = array_sample * array_sample
# array_theta_down_delta = angle_fm / array_sample[-1]
# array_sample = angle_fm - array_sample * array_theta_down_delta
# print("array_sample 2 ============", array_sample * 360. / 2./ np.pi)

### 流線角度：任意
# array_sample = np.array([10., 9.9999999999, 9.9999999998, 9., 8., 6.5, 5., 2.5, 1., 0.])/360.*2.*np.pi
# array_sample = np.array([10., 8., 6., 5., 4., 3., 2.5, 2., 1., 0.])/360.*2.*np.pi
# array_sample = np.array([10., 6., 4., 3., 2.5, 2., 1.5, 1., 0.5, 0.])/360.*2.*np.pi
# array_sample = np.array([10., 9.995, 9.8, 9.3, 9., 4.5, 4., 2., 1., 0.])/360.*2.*np.pi
# array_sample = np.array([10., 9.95, 9.96, 9.98, 9.9, 7., 4., 2., 1., 0.])/360.*2.*np.pi
# print("array_theta_down 2 ============", array_sample * 360. / 2./ np.pi)
...
# print('array_neu_down[0]',array_neu_down[:5])
...
# print('neu')
# print(array_neu_down/2./np.pi*360.)
# print('alpha')
# print(array_alpha_down/2./np.pi*360.)
...
print("/// array_x            ///", array_x[int(num_ch_up-1)][1])
print("/// array_y            ///", array_y[int(num_ch_up-1)][1])
# print("/// array_lambda_plus  ///", array_lambda_plus[int(num_ch_up)][0])
# print("/// array_lambda_minus ///", array_lambda_minus[int(num_ch_up-2)][1])
