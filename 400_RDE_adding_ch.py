...
def func_M2neu(M, gamma=gamma_eq_post):
    part1 = ((gamma+1.)/(gamma-1.))**(1./2.)
    part2 = np.arctan(((gamma-1.)/(gamma+1.)*(M**2.-1.))**(1./2.))
    part3 = np.arctan((M**2.-1.)**(1./2.))
...
### マッハ数：等差
M_post = 1.
neu_sl = angle_sl - (angle_fm - func_M2neu(M_post))
M_sl = func_neu2M(neu_sl)
...
for i0 in range(int(num_ch_up)):
    array_neu_up[i0] = func_M2neu(array_M_up[i0])
...
array_theta_up = array_neu_up + (angle_fm - func_M2neu(M_post))
...
### マッハ数：等差
M_post = 1.
neu_bottom = -angle_bottom + (angle_fm + func_M2neu(M_post))
M_bottom = func_neu2M(neu_bottom)
...
for i0 in range(int(num_ch_down)):
    array_neu_down[i0] = func_M2neu(array_M_down[i0])
...
array_theta_down = -array_neu_down + (angle_fm + func_M2neu(M_post))
...
array_T_minus = func_add_ch(array_T_minus)
array_p_minus = func_add_ch(array_p_minus)
array_theta_minus = func_add_ch(array_theta_minus)
array_V_minus = func_add_ch(array_V_minus)
array_rho_minus = func_add_ch(array_rho_minus)
array_y_minus = func_add_ch(array_y_minus)
array_a_fr_minus = func_add_ch(array_a_fr_minus)
array_M_minus = func_add_ch(array_M_minus)
array_alpha_minus = func_add_ch(array_alpha_minus)
array_lambda_minus = func_add_ch(array_lambda_minus)
array_Q_minus = func_add_ch(array_Q_minus)
array_S_minus = func_add_ch(array_S_minus)
