...
### 流線角度：等差二分割
array_theta_up = np.linspace(angle_fm,angle_sl*1./4.,int(num_ch_up*2./5.+1))
array_theta_up = np.delete(array_theta_up,-1,0)
array_theta_up = np.hstack((array_theta_up, np.linspace(array_theta_up[-1],angle_sl,int(num_ch_up*3./5.))))
print("array_theta_up ============", array_theta_up * 360. / 2./ np.pi)
...
### 流線角度：等差二分割
array_theta_down = np.linspace(angle_fm,angle_bottom*1./4.,int(num_ch_down*2./5.+1))
array_theta_down = np.delete(array_theta_down,-1,0)
array_theta_down = np.hstack((array_theta_down,np.linspace(array_theta_down[-1],angle_bottom,int(num_ch_down*3./5.))))
print("array_theta_dwon ============", array_theta_down * 360. / 2./ np.pi)
